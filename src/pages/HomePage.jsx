...
const HomePage = () => {
    ...
    return (
        ...
        .hp-stat-live  {
          ...
          color: rgba(34,197,94,.6); letter-spacing: .05em; margin-top: 2px;
        }
        .hp-stat-dot {
          width: 5px; height: 5px; border-radius: 50%;
          background: #22c55e;
            ...
            <div className="hp-page">
                ...
                <div className="hp-hero">
                    ...
                    <div className="hp-stats">
                        {[
                            { num: liveStats.problems,    label:'Problems',    sub:'Easy · Medium · Hard', live: true  },
                            { num: '8',                   label:'Languages',   sub:'C++ · Java · Python',  live: false },
                            { num: liveStats.submissions, label:'Submissions', sub:'Auto Evaluated',        live: true  },
                            { num: liveStats.users,       label:'Users',       sub:'Active Learners',       live: true  },
                        ].map((s, i) => (
                            <div key={i} className="hp-stat" style={{ animationDuration:'4s' }}>
                                ...
                                {s.live && (
                                    <span className="hp-stat-live">
                                        <span className="hp-stat-dot" />
                                        live
                                    </span>
                                )}
                            </div>
                ...
                <div className="hp-section" style={{ paddingTop:0 }}>
                    ...
                    <h2 className="hp-sec-title" style={{ fontSize:'clamp(20px,2.5vw,30px)', marginBottom:28 }}>
                        {liveStats.problems} Problems across{' '} 
...
//                     <div className="hp-stats">
//                         {[
//                             { num: liveStats.problems,    label:'Problems',    sub:'Easy · Medium · Hard' },
//                             { num: '8',                   label:'Languages',   sub:'C++ · Java · Python'  },
//                             { num: liveStats.submissions, label:'Submissions', sub:'Auto Evaluated'        },
//                             { num: liveStats.users,       label:'Users',       sub:'Active Learners'       },
//                         ].map((s, i) => (
//                             <div key={i} className="hp-stat" style={{ animationDuration:'4s' }}>
//                                 <span className="hp-stat-num">{s.num}</span>
//                                 <span className="hp-stat-label">{s.label}</span>
...
//     useEffect(() => {
//         const fetchStats = async () => {
//             const [{ count: subCount }, { count: userCount }] = await Promise.all([
//                 supabase.from('Submissions').select('*', { count: 'exact', head: true }),
//                 supabase.from('Users').select('*', { count: 'exact', head: true }),
//             ])
//             setLiveStats({
